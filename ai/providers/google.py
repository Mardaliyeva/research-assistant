...
def _make_gemini_client(api_key: str | None):
    # Support both Google- and Gemini-named environment variables for convenience.
    key = (
        api_key
...
class GeminiLLM(LLMProvider):
    ...
    def complete(
        ...
        *,
        ...
        full_prompt = prompt
        # When a schema is requested, ask Gemini for JSON and include the schema text.
    ...
    def describe(
        ...
        *,
        ...
        try:
            ...
            # Gemini's SDK uploads the file first, then references it in generate_content.
...
class GeminiEmbedding(EmbeddingProvider):
    ...
    def embed(self, text: str) -> np.ndarray:
        ...
        # Unit-normalize embeddings to match the EmbeddingProvider contract.
