...
def _make_openai_client(api_key: str | None):
    # Accept either an explicit key or common environment-variable names.
...
class OpenAILLM(LLMProvider):
    ...
    def complete(
        ...
        *,
        ...
        # Build kwargs incrementally so structured JSON mode is optional.
        kwargs: dict = {
            "model": self.model,
...
class OpenAIVLM(VLMProvider):
    ...
    def describe(
        ...
        *,
        ...
        # Chat Completions expects local images as base64 data URLs.
...
class OpenAIEmbedding(EmbeddingProvider):
    ...
    def embed(self, text: str) -> np.ndarray:
        ...
        # Unit-normalize so cosine similarity can be computed as a dot product.
...
def _guess_media_type(path: Path) -> str:
    # Restrict uploads to image formats supported by the provider adapters.
